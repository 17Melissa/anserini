...
# Define paths
file_path_vectors = 'doc_vectors/vectors.safetensors'
file_path_docids = 'doc_vectors/docids.safetensors'
...
input_file_path = 'vectors.part01.jsonl'
vectors = []
docids = []
...
docid_to_idx_path = 'doc_vectors/docid_to_idx.json'  # Update with your actual path
